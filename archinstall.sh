...
# paru -S git fish xorg xorg-xinit xorg-drivers libinput wayland wlroots libxkbcommon wayland-protocols pkgconf nvidia nvidia-settings nvidia-utils acpi dracula-gtk-theme bottom clang cmake dunst mako eza feh flameshot gvfs gvfs-gphoto2 gvfs-mtp libnotify lxappearance-gtk3 make mpv mtpfs ncdu neovim-nightly-bin nodejs npm ntfs-3g chrony openssh pavucontrol pipewire-alsa pipewire-audio pipewire-pulse pipewire-session-manager playerctl tar tldr transmission-gtk3 ttf-comfortaa ttf-fira-sans ttf-jetbrains-mono-nerd ttf-iosevka-nerd ttf-ubuntu-font-family unzip usbutils vulkan-amdgpu-pro vulkan-headers wget xbindkeys xclip wl-clipboard ybacklight zip slurp grim nwg-look swayimg dmenu-wayland-git waycheck wlr-randr firefox thunar papirus-icon-theme qogir-cursor-theme-git wev
sudo pacman -S --needed git fish xorg xorg-xinit xorg-drivers libinput wayland wlroots libxkbcommon wayland-protocols pkgconf nvidia nvidia-settings nvidia-utils acpi bottom clang cmake dunst mako eza feh flameshot gvfs gvfs-gphoto2 gvfs-mtp libnotify lxappearance-gtk3 make mpv mtpfs ncdu nodejs npm ntfs-3g chrony openssh pavucontrol pipewire-alsa pipewire-audio pipewire-pulse pipewire-session-manager playerctl tar tldr ttf-fira-sans ttf-jetbrains-mono-nerd ttf-iosevka-nerd ttf-ubuntu-font-family unzip usbutils vulkan-headers wget xbindkeys xclip wl-clipboard zip slurp grim nwg-look swayimg swaybg waycheck wlr-randr firefox thunar papirus-icon-theme wev
