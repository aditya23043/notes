# 1 "ELD_project/solution1/fft.c"
# 1 "ELD_project/solution1/fft.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 149 "<built-in>" 3
# 1 "<command line>" 1
...
# 1 "/home/adi/hdd/Xilinx/Vivado/2019.1/common/technology/autopilot/etc/autopilot_ssdm_op.h" 1
# 305 "/home/adi/hdd/Xilinx/Vivado/2019.1/common/technology/autopilot/etc/autopilot_ssdm_op.h"
...
# 7 "<command line>" 2
# 1 "<built-in>" 2
# 1 "ELD_project/solution1/fft.c" 2
...
# 1 "/home/adi/hdd/Xilinx/Vivado/2019.1/lnx64/tools/clang/bin/../lib/clang/3.1/include/stddef.h" 1 3 4
# 31 "/home/adi/hdd/Xilinx/Vivado/2019.1/lnx64/tools/clang/bin/../lib/clang/3.1/include/stddef.h" 3 4
...
# 1 "/home/adi/hdd/Xilinx/Vivado/2019.1/lnx64/tools/clang/bin/../lib/clang/3.1/include/stdarg.h" 1 3 4
# 30 "/home/adi/hdd/Xilinx/Vivado/2019.1/lnx64/tools/clang/bin/../lib/clang/3.1/include/stdarg.h" 3 4
typedef __builtin_va_list va_list;
# 48 "/home/adi/hdd/Xilinx/Vivado/2019.1/lnx64/tools/clang/bin/../lib/clang/3.1/include/stdarg.h" 3 4
...
# 4 "ELD_project/solution1/fft.c" 2
...
# 5 "ELD_project/solution1/fft.c" 2
...
# 6 "ELD_project/solution1/fft.c" 2



const int rev8[8] = {0, 4, 2, 6, 1, 5, 3, 7};
const float _Complex W[8/2] = {1-0*(__extension__ 1.0iF), 0.7071067811865476-0.7071067811865475*(__extension__ 1.0iF), 0.0-1*(__extension__ 1.0iF), -0.7071067811865475-0.7071067811865476*(__extension__ 1.0iF)};

void bitreverse(float _Complex dataIn[8], float _Complex dataOut[8]);
void FFT_stages (float _Complex FFT_input[8], float _Complex FFT_output [8]);

void bitreverse(float _Complex dataIn[8], float _Complex dataOut[8]){_ssdm_SpecArrayDimSize(dataIn, 8);_ssdm_SpecArrayDimSize(dataOut, 8);
    bit_reversal:
        for (int i = 0; i < 8; i++){
...
void FFT_stages (float _Complex FFT_input[8], float _Complex FFT_output [8]){_ssdm_SpecArrayDimSize(FFT_input, 8);_ssdm_SpecArrayDimSize(FFT_output, 8);
    float _Complex temp1[8], temp2[8];
...
void FFT(float _Complex FFT_input[8], float _Complex FFT_output[8]){_ssdm_SpecArrayDimSize(FFT_input, 8);_ssdm_SpecArrayDimSize(FFT_output, 8);
 float _Complex FFT_rev[8];
