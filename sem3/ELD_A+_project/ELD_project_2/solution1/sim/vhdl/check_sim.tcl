...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.fft_8point.autotvin_FFT_input_M_real.dat"
         "c.fft_8point.autotvin_FFT_input_M_imag.dat"
         "c.fft_8point.autotvin_FFT_output_M_real.dat"
         "c.fft_8point.autotvin_FFT_output_M_imag.dat"
         "c.fft_8point.autotvout_FFT_output_M_real.dat"
         "c.fft_8point.autotvout_FFT_output_M_imag.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.fft_8point.autotvout_FFT_output_M_real.dat"
         "rtl.fft_8point.autotvout_FFT_output_M_imag.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
