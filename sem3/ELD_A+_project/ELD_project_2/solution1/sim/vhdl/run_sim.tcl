...
if {[file isfile fft_8point.autotvin.dat]} {
	file delete -force fft_8point.autotvin.dat
}

if {[file isfile fft_8point.autotvout.dat]} {
	file delete -force fft_8point.autotvout.dat
}
