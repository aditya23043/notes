...
HD_PWD='/home/adi/repo/notes/sem3/ELD2024_LAB/lab7_hw_2/lab7_hw_2.runs/FL_add_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FL_add.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FL_add.tcl
