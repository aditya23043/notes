...
#
# Generated by export_simulation on Sat Oct 19 17:13:46 IST 2024
#
################################################################################
...
'-reset_run' switch to the './xfft_03.sh' script.

./xfft_03.sh -reset_run
...
./xfft_03.sh -noclean_files

For more information on the script, please type './xfft_03.sh -help'.
