...
HD_PWD='/home/adi/repo/notes/sem3/ELD2024_LAB/lab7_hw_1/lab7_hw_1.runs/xfft_03_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xfft_03.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xfft_03.tcl
