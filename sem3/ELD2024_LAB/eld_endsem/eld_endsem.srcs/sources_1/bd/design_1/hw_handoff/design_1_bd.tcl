...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net axis_dwidth_converter_0_M_AXIS [get_bd_intf_pins axis_dwidth_converter_0/M_AXIS] [get_bd_intf_pins xfft_0/S_AXIS_DATA]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets xfft_0_M_AXIS_DATA] [get_bd_intf_pins system_ila_0/SLOT_0_AXIS] [get_bd_intf_pins xfft_0/M_AXIS_DATA]
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins floating_point_0/s_axis_b_tdata] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins floating_point_0/s_axis_b_tvalid] [get_bd_pins xlconstant_1/dout]
  connect_bd_net -net xlconstant_2_dout [get_bd_pins xfft_0/s_axis_config_tdata] [get_bd_pins xlconstant_2/dout]
  connect_bd_net -net xlconstant_3_dout [get_bd_pins xfft_0/s_axis_config_tvalid] [get_bd_pins xlconstant_3/dout]
