...
HD_PWD='/home/adi/repo/notes/sem3/ELD2024_LAB/lab6/lab6.runs/FL_log_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FL_log.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FL_log.tcl
